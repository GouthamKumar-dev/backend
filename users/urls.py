...
from .views import  CustomTokenObtainPairView, LogoutView, CustomTokenRefreshView, UpdateShippingAddressView, user_me, SignupView, LoginView, CreateUserView, AdminUserListView
